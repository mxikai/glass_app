...
def main():
    ...
    light_palette.setColor(QPalette.ColorRole.Window, QColor(238, 240, 248))
    light_palette.setColor(QPalette.ColorRole.WindowText, QColor(26, 26, 62))     
    light_palette.setColor(QPalette.ColorRole.Base, QColor(255, 255, 255))        
    light_palette.setColor(QPalette.ColorRole.AlternateBase, QColor(245, 246, 250))
    ...
    light_palette.setColor(QPalette.ColorRole.Highlight, QColor(108, 92, 231))  
